...
export default async function handler(req, res) {
  ...
  const cloudinaryUrl = `https://res.cloudinary.com/dvgje8p9s/image/upload/l_text:Arial_35_bold:${uniqueCode},g_south_west,x_50,y_30/v1772260712/blank_coupon_kwdgvu.png`;
